  ...
  return (
    <div className="App">
      <body>
        ...
        <div>
          <UpdateButton
            buttonLabel="Update Adjective"
            onUpdateRequested={fetchAdjective}
          />
          <UpdateButton
            buttonLabel="Update Noun"
            onUpdateRequested={fetchNoun}
          />
          <UpdateButton
            buttonLabel="New trend"
            onUpdateRequested={() => {
              fetchNoun();
              fetchAdjective();
            }}
...
function UpdateButton({ buttonLabel, onUpdateRequested }) {
  return <button onClick={onUpdateRequested}>{buttonLabel}</button>;
}
